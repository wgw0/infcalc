...
## Features
1. **Daily Compounded Interest Calculation**: Interest is compounded daily based on the annual rate.
2. **User-Friendly Interface**: Easy-to-use input fields for the initial sum, interest rate, and time frame.
3. **Dynamic Graph**: A line graph shows the growth of the investment over time, updating whenever new calculations are made.
...
You can use it easily here: [https://wgw0.github.io/infcalc/](https://wgw0.github.io/infcalc/)
...
4. Click the "Calculate" button to see the final amount and the investment's growth chart.

## References and Credits
- **[Chart.js](https://www.chartjs.org/)**: A JavaScript library used to create the interactive graph.
